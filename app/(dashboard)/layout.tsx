...
import { getDashboardInitialState } from "@/lib/data/dashboard";

// getDashboardInitialState is React.cache()-wrapped in lib/data/dashboard.ts.
// Both this layout and dashboard/page.tsx call it — the second call is free.
...
export default async function DashboardLayout({
  ...
  // getDashboardInitialState is React.cache()-memoized — if dashboard/page.tsx
  // calls it first (or simultaneously), this call resolves from the same Promise.
  const { orders, notifications, pendingOrders, pendingCount } =
    await getDashboardInitialState(shop.id);
