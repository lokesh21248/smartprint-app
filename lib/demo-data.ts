...
export const DEMO_SHOP: Shop = {
  ...
  name: "Ravi Xerox & Print",
  slug: "ravi-xerox",
  address: "12, MG Road, Near Bus Stand, Hyderabad, Telangana 500001",
  phone: "9876543210",
  owner_email: "ravi.xerox@gmail.com",
...
export const DEMO_ORDERS: Order[] = [
  {
    ...
    file_s3_key: "demo/Assignment_Final.pdf",
    file_name: "Assignment_Final.pdf",
    page_count: 24,
    copies: 2,
    color: false,
    double_sided: false,
    notes: "Please use 80gsm paper only",
    total_amount: 126,
    order_status: "PLACED",
    status_history: [{ status: "PLACED", at: mins(3), actor: "customer" }],
    created_at: mins(3),
    updated_at: mins(3),
  },
  {
